...
def view_individual_student():
    student_name = search_entry.get().strip()
    for student in students:
...
# Entry for searching a student by name
search_entry = tk.Entry(individual_frame, width=40, font=("Arial", 12))
search_entry.pack(side=tk.LEFT, padx=(0, 5))
search_entry.insert(0, "Enter student name")  # Placeholder text
